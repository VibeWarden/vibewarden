...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("resilience.circuit_breaker.enabled", false)
	v.SetDefault("resilience.circuit_breaker.threshold", 5)
	v.SetDefault("resilience.circuit_breaker.timeout", "60s")
	v.SetDefault("resilience.retry.enabled", false)
	v.SetDefault("resilience.retry.max_attempts", 3)
	v.SetDefault("resilience.retry.backoff", "100ms")
	v.SetDefault("resilience.retry.max_backoff", "10s")
	v.SetDefault("resilience.retry.retry_on", []int{502, 503, 504})
