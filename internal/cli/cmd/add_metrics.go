...
Adds the metrics configuration section. Metrics are exposed at
/_vibewarden/metrics by default and can be scraped by Prometheus or any
compatible collector.

Next steps after enabling metrics:
  1. Restart VibeWarden
  2. Scrape https://localhost:8443/_vibewarden/metrics with Prometheus
