...
// Admin endpoints are protected by a static bearer token supplied in either
// the X-Admin-Key request header or the standard Authorization: Bearer header.
type AdminAuthConfig struct {
	...
	// header, or as Authorization: Bearer <token>, to access
	// /_vibewarden/admin/* endpoints. Must be non-empty when
